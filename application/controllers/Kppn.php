...
class Kppn extends CI_Controller {
	private $data;
	...
	public function list(){
		...
		$data = $this->kppn_model->get($filters, $limit);
		//var_dump($data);
		$total_data = count($this->kppn_model->get($filters));
		$limit[] = $total_data;
	...
	public function update(){
		...
		if(isset($_POST['submit'])){
			...
			$filter = array();
			$filter[] = "ID = ". $_POST['id'];
			$this->data['result'] = $this->kppn_model->get($filter);
	...
	public function detail($id=null){
		...
		if(isset($_POST['id']) and $_POST['id'] != null){
			$filters = array();
			$filters[] = "ID = ". $_POST['id'];
			$data = $this->kppn_model->get($filters);
	...
	public function update_status(){
		...
		if(isset($_POST['id']) and $_POST['id'] != null){
			...
			$result = $this->kppn_model->get($filters);
			if($result != null){
	...
	public function delete(){
		...
		$result = $this->kppn_model->delete($this->data['delete']);
