...
class Status_laporan extends CI_Controller {
	...
	public function __construct(){
		...
		$this->data['title'] = 'Status Laporan';
	}
	...
	public function list(){
		...
		$data = $this->status_laporan_model->get($filters, $limit);
		//var_dump($data);
		$total_data = count($this->status_laporan_model->get($filters));
		$limit[] = $total_data;
	...
	public function insert(){
		...
		if(isset($_POST['submit'])){
			...
			if($error_status == true){
				...
				$result = $this->status_laporan_model->insert($this->data['insert']);
				$info = array();
	...
	public function update(){
		...
		if(isset($_POST['submit'])){
			...
			if($error_status == true){
				...
				$result = $this->status_laporan_model->update($this->data['update'], $_POST['id']);
				if($result == true){
					$info = array();
			...
			$filter = array();
			$filter[] = "ID = ". $_POST['id'];
			$this->data['result'] = $this->status_laporan_model->get($filter);
	...
	public function detail($id=null){
		...
		if(isset($_POST['id']) and $_POST['id'] != null){
			$filters = array();
			$filters[] = "ID = ". $_POST['id'];
			$data = $this->status_laporan_model->get($filters);
	...
	public function update_status(){
		...
		if(isset($_POST['id']) and $_POST['id'] != null){
			...
			$result = $this->status_laporan_model->get($filters);
			if($result != null){
	...
	public function delete(){
		...
		$result = $this->status_laporan_model->delete($this->data['delete']);
