...
class Bidang extends CI_Controller {
	...
	public function list(){
		...
		$data = $this->bidang_model->get($filters, $limit);
		//var_dump($data);
		$total_data = count($this->bidang_model->get($filters));
		$limit[] = $total_data;
	...
	public function insert(){
		...
		if(isset($_POST['submit'])){
			...
			if($error_status == true){
				...
				$result = $this->bidang_model->insert($this->data['insert']);
				$info = array();
	...
	public function update(){
		...
		if(isset($_POST['submit'])){
			...
			if($error_status == true){
				...
				$result = $this->bidang_model->update($this->data['update'], $_POST['id']);
				if($result == true){
					$info = array();
			...
			$filter = array();
			$filter[] = "ID = ". $_POST['id'];
			$this->data['result'] = $this->bidang_model->get($filter);
	...
	public function detail($id=null){
		...
		if(isset($_POST['id']) and $_POST['id'] != null){
			$filters = array();
			$filters[] = "ID = ". $_POST['id'];
			$data = $this->bidang_model->get($filters);
	...
	public function update_status(){
		...
		if(isset($_POST['id']) and $_POST['id'] != null){
			...
			$result = $this->bidang_model->get($filters);
			if($result != null){
	...
	public function delete(){
		...
		$result = $this->bidang_model->delete($this->data['delete']);
